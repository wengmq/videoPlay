...
//    {
//        QPixmap temp_label = QPixmap(":../image/video/"+QString::number(i)+".jpg");
...
//    {
//        lineAction[actions_num]=new QAction(QIcon(":../image/video/line.png"),"",transferBar);
...
//    }
//    lineAction[default_choose]->setIcon(QIcon(":../image/video/lineChose.png"));
...
//            lineAction[action_num]->setIcon(QIcon(":../image/video/line.png"));
//        else
//            hover_action_num = action_num;
//    }
//    actionSender->setIcon(QIcon(":../image/video/lineChose.png"));
